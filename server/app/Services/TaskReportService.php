...
class TaskReportService
{
    ...
    public function sendReportByEmail(string $report, string $toEmail, string $fromEmail = 'ghalayinisaleh9@gmail.com')
    {
        Mail::raw($report, function ($message) use ($fromEmail, $toEmail) {
