...
class AIToolsService
{
    ...
    protected MeetingToolsService $meetingToolsService;
    protected ReportToolsService $reportToolsService;
    protected CalendarToolsService $calendarToolsService;
    protected EmployeeToolsService $employeeToolsService;
